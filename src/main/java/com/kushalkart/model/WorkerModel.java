...
public class WorkerModel {
    ...
    // Constructor to map from entity (assuming entity class is com.kushalkart.entity.Worker)
    public WorkerModel(com.kushalkart.entity.Worker worker) {
        ...
        this.verified = worker.isVerified();  // Note the use of isVerified() for primitive boolean
